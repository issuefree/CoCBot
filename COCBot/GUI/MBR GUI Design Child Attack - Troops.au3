...
$sTxtBowlers = GetTranslated(604,19, "Bowlers")
...
$sTxtLightning = GetTranslated(605,1, "Lightning Spell")
$sTxtHeal = GetTranslated(605,2, "Healing Spell")
$sTxtRage = GetTranslated(605,3, "Rage Spell")
$sTxtJump = GetTranslated(605,4, "Jump Spell")
$sTxtFreeze = GetTranslated(605,5, "Freeze Spell")
$sTxtPoison = GetTranslated(605,6, "Poison Spell")
$sTxtEarth = GetTranslated(605,7, "EarthQuake Spell")
$sTxtHaste = GetTranslated(605,8, "Haste Spell")
...
Local $x = $xStart +  25, $y = $yStart +  80 + 25 - 60
	$grpTroopComp = GUICtrlCreateGroup(GetTranslated(621,1, "Elixir Troops"), $x - 20, $y - 20, 142, 50)
		...
		$cmbTroopComp = GUICtrlCreateCombo("", $x - 10, $y, 130, 25, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
			...
			GUICtrlSetData(-1, GetTranslated(621,4, "Preset: Archers") &"|" & GetTranslated(621,5, "Preset: Barbarians") & "|" & GetTranslated(621,6, "Preset: Goblins") & "|" & GetTranslated(621,7, "Preset: B.Arch") & "|" &  GetTranslated(621,8, "Preset: B.A.G.G.") & "|" & GetTranslated(621,9, "Preset: B.A.Giant") & "|" & GetTranslated(621,10, "Preset: B.A.Goblin")  &"|" & GetTranslated(621,11, "Preset: B.A.G.G.Wall") & "|" & GetTranslated(621,12, "Use Barrack Mode") & "|" & GetTranslated(621,13, "Custom Army") & "|" & "Resource", GetTranslated(621,13, -1))
	GUICtrlCreateGroup("", -99, -99, 1, 1)
...
Local $x = $xStart +  160 + 5, $y = $yStart +  75 + 25
	$grpOtherTroops = GUICtrlCreateGroup(GetTranslated(621,22, "Add. Troops"), $x - 15, $y - 20, 139, 200)
		...
		$lblPekka = GUICtrlCreateLabel($sTxtPekkasLong, $x + 16, $y, -1, -1)
