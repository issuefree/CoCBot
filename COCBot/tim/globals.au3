...
$UnitTime[$iGoblin] = 30
$UnitTime[$iWallBreaker ] = 60
$UnitTime[$iBalloon] = 5*60
$UnitTime[$iWizard] = 5*60
$UnitTime[$iHealer] = 10*60
$UnitTime[$iDragon] = 15*60
$UnitTime[$iPekka] = 15*60
$UnitTime[$iMinion] = 45
$UnitTime[$iHogRider] = 2*60
$UnitTime[$iValkyrie] = 5*60
$UnitTime[$iGolem] = 15*60
$UnitTime[$iWitch] = 10*60
$UnitTime[$iLavaHound] = 15*60
